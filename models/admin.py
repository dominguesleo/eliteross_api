...
class ClientAdmin(admin.ModelAdmin):
    ...
    list_filter = ('gender', 'is_smoker', 'cigarette_per_day', 'is_diabetic', 'diabetic_type', 'physical_activity_at_work', 'is_physically_active', 'level_of_physical_activity', 'hours_of_sleep', 'is_active')
    ...
    fieldsets = (
        ...
        ('Health Information', {'fields': ('is_smoker', 'cigarette_per_day', 'is_diabetic', 'diabetic_type', 'cholesterol', 'blood_pressure', 'heart_rate', 'altered_analytical_data', 'disease', 'surgery', 'injury', 'contraindicated_physical_activity')}),
        ('Sports, rest, and nutrition', {'fields': ('is_physically_active', 'physical_inactivity_per_month', 'physical_activity', 'level_of_physical_activity', 'days_available_for_training', 'hours_of_sleep', 'daily_meals', 'allergies_intolerances')}),
